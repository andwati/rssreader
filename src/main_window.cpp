...
void RSSReader::setupConnections() {
    connect(d->addFeedButton, &QPushButton::clicked, this, &RSSReader::addNewFeed);
    connect(d->feedList, &QListWidget::currentRowChanged, this, &RSSReader::loadFeedContent);
    connect(d->articleList, &QListWidget::currentRowChanged, this, &RSSReader::displayArticle);
}
